# Retina Eye Disease Detection App

## Project info

This is a native cross-platform mobile app for eye disease detection using AI/ML models.
...
- Visit [Expo's FAQ](https://docs.expo.dev/) for platform-specific questions

## About This App

This app is built with React Native and Expo - the same technology stack used by Discord, Shopify, Coinbase, Instagram, and nearly 30% of the top 100 apps on the App Store.
